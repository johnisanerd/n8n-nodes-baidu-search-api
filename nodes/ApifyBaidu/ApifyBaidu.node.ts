...
import { properties } from './ApifyBaidu.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'hDVd9ZQQHglV5LZ1A' as string;

export const PACKAGE_NAME = 'n8n-nodes-baidu-search-api' as string;
export const CLASS_NAME = 'ApifyBaidu' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'baidu-search-app' as string;

export const DISPLAY_NAME = 'Baidu Search' as string;
export const DESCRIPTION =
	'Search Baidu and return organic results with titles, links, and snippets' as string;

export class ApifyBaidu implements INodeType {
